...
// BuiltInBackend handles Git repository operations using go-git library
...
// NewBuiltInBackend creates a new Git repository backend using built-in go-git library
func NewBuiltInBackend(repoURL, localPath, username, token string) *BuiltInBackend {
...
func (m *BuiltInBackend) Clone(ctx context.Context) error {
...
func (m *BuiltInBackend) Pull(ctx context.Context) error {
	if m.repo == nil {
...
func (m *BuiltInBackend) Commit(ctx context.Context, message string) error {
	if m.repo == nil {
		return fmt.Errorf("repository not initialized")
	}
...
func (m *BuiltInBackend) Push(ctx context.Context) error {
	if m.repo == nil {
		return fmt.Errorf("repository not initialized")
	}
...
func (m *BuiltInBackend) createNewRepo(ctx context.Context) error {
...
func (m *BuiltInBackend) ListBranches(ctx context.Context) ([]BranchInfo, error) {
	if m.repo == nil {
...
func (m *BuiltInBackend) GetCurrentBranch(ctx context.Context) (string, error) {
	if m.repo == nil {
		return "", fmt.Errorf("repository not initialized")
	}
...
func (m *BuiltInBackend) CreateBranch(ctx context.Context, branchName string) error {
	if m.repo == nil {
		return fmt.Errorf("repository not initialized")
	}
...
func (m *BuiltInBackend) SwitchBranch(ctx context.Context, branchName string) error {
	if m.repo == nil {
		return fmt.Errorf("repository not initialized")
	}
...
func (m *BuiltInBackend) DeleteBranch(ctx context.Context, branchName string, force bool) error {
	if m.repo == nil {
		return fmt.Errorf("repository not initialized")
	}
...
func (m *BuiltInBackend) PushBranch(ctx context.Context, branchName string) error {
	if m.repo == nil {
		return fmt.Errorf("repository not initialized")
	}
...
func (m *BuiltInBackend) HasUncommittedChanges(ctx context.Context) (bool, error) {
	if m.repo == nil {
...
func (m *BuiltInBackend) GetStatusSummary(ctx context.Context) (string, error) {
	if m.repo == nil {
		return "", fmt.Errorf("repository not initialized")
	}
